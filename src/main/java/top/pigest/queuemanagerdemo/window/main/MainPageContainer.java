...
public class MainPageContainer extends BorderPane {
    ...
    public MainPageContainer(MainScene parent) {
        ...
        functions.add(parent.createMainFunctionButton("#357c56", "#73be95", "弹幕服务", "fas-hamburger", DanmakuServiceContainer::new), 0, 0);
        functions.add(parent.createMainFunctionButton("#ae5220", "#cf9d81", "排队系统", "fas-list-ol", QueueSystemContainer::new), 1, 0);
        functions.add(parent.createMainFunctionButton("#932121", "#c15757", "点歌系统", "fas-music", MusicSystemContainer::new), 0, 1);
        functions.add(parent.createMainFunctionButton("#0d608f", "#1a8bcc", "更多功能", "fas-dice-d6", () -> null), 1, 1);
